...
CTFrontendBuilderUI.controller("ControllerDragnDrop",["$scope","$timeout","dragulaService",function(f,t,e){var a,n=null,g=null,m=0,c=function(t){var e=0;if(0==t.length)return e;for(i=0;i<t.length;i++)char=t.charCodeAt(i),e=(e<<5)-e+char,e&=e;return e};f.$parent.$on("iframe-init",function(t,b){e.options(f.iframeScope,"ct-dom-tree",{isContainer:function(t){return!(!t.classList.contains("ct-accept-drops")||!n)||!!t.classList.contains("ct-draggable")&&!(n=!0)},moves:function(t,e,s){return n=null,!(e.classList.contains("ct-sortable-header")&&jQuery(e).children().length<5)&&(s.classList.contains("ct-draggable")||0<jQuery(s).closest(".ct-handle").length)},accepts:function(t,e,s,n){parseInt(t.getAttribute("ng-attr-tree-id"));if(g&&0<parseInt(e.getAttribute("ng-attr-tree-id"))&&parseInt(e.getAttribute("ng-attr-tree-id"))!==m&&(clearTimeout(g),g=!1,m=0),e.classList.contains("ct-accept-drops")&&0<parseInt(e.getAttribute("ng-attr-tree-id"))){var r=parseInt(e.getAttribute("ng-attr-tree-id")),a=jQuery("#ct-dom-tree-node-"+r+" >.ct-dom-tree-node-anchor");0!==m||f.iframeScope.toggledNodes[r]||r===parseInt(t.getAttribute("ng-attr-tree-id"))||(m=r,g=setTimeout(function(){a.find(".ct-expand-butt").trigger("click"),m=0},1e3));var c=jQuery(e).offset().left;if(jQuery(".gu-mirror").offset().left-c<16)return!1}if(n&&n.classList.contains("ct-dom-tree-node-anchor"))return!1;if(t.classList.contains("ct-sortable-li")&&!e.classList.contains("ct-sortable-ul"))return!1;if((t.classList.contains("ct-sortable-if-wrap")||t.classList.contains("ct-sortable-else-wrap"))&&!e.classList.contains("ct-sortable-if-else-wrap"))return!1;if(!t.classList.contains("ct-sortable-if-wrap")&&!t.classList.contains("ct-sortable-else-wrap")&&e.classList.contains("ct-sortable-if-else-wrap"))return!1;if(e.classList.contains("ct-sortable-dynamic-list")&&!t.classList.contains("ct-sortable-div-block"))return!1;if(e.classList.contains("ct-sortable-dynamic-list")&&t.classList.contains("ct-sortable-div-block")){r=parseInt(e.getAttribute("ng-attr-tree-id"));var i=b.getComponentById(r);if(0<i.length&&0<i.children().length)return!1}if(!t.classList.contains("ct-sortable-li")&&e.classList.contains("ct-sortable-ul"))return!1;if(t.classList.contains("ct-sortable-slide")&&!e.classList.contains("ct-sortable-slider"))return!1;if(!t.classList.contains("ct-sortable-slide")&&e.classList.contains("ct-sortable-slider"))return!1;if(t.classList.contains("ct-sortable-column")&&!e.classList.contains("ct-sortable-columns"))return!1;if(!t.classList.contains("ct-sortable-column")&&e.classList.contains("ct-sortable-columns"))return!1;if(!t.classList.contains("ct-sortable-div-block")&&e.classList.contains("ct-sortable-new-columns"))return!1;if(!t.classList.contains("ct-sortable-tab")&&e.classList.contains("ct-sortable-tabs"))return!1;if(!t.classList.contains("ct-sortable-tab-content")&&e.classList.contains("ct-sortable-tabs-contents"))return!1;if((t.classList.contains("ct-sortable-tabs")||t.classList.contains("ct-sortable-tabs-contents"))&&(jQuery(e).parents(".ct-sortable-tabs").length||jQuery(e).parents(".ct-sortable-tabs-contents").length))return!1;if(t.classList.contains("ct-sortable-tab")&&!e.classList.contains("ct-sortable-tabs"))return!1;if(t.classList.contains("ct-sortable-tab-content")&&!e.classList.contains("ct-sortable-tabs-contents"))return!1;if(t.classList.contains("ct-sortable-grid-cell")&&!e.classList.contains("ct-sortable-grid"))return!1;if(!t.classList.contains("ct-sortable-grid-cell")&&e.classList.contains("ct-sortable-grid"))return!1;if(t.classList.contains("ct-sortable-section")&&0<angular.element(e).closest(".ct-sortable-section").length)return!1;if(t.classList.contains("ct-sortable-section")&&0<angular.element(e).closest(".ct-sortable-header").length)return!1;if(t.classList.contains("ct-sortable-section")&&0<angular.element(e).closest(".ct-sortable-slider").length)return!1;if(t.classList.contains("ct-sortable-header")&&0<angular.element(e).closest(".ct-sortable-section").length)return!1;if(t.classList.contains("ct-sortable-header")&&0<angular.element(e).closest(".ct-sortable-header").length)return!1;if(t.classList.contains("ct-sortable-link")&&0<angular.element(e).closest(".ct-sortable-link").length)return!1;if(t.classList.contains("ct-sortable-link-text")&&0<angular.element(e).closest(".ct-sortable-link").length)return!1;if(e.classList.contains("gu-transit")||!e.classList.contains("ct-accept-drops"))return!1;if(!t.classList.contains("ct-sortable-header-row")&&e.classList.contains("ct-sortable-header"))return!1;if(t.classList.contains("ct-sortable-header-row")&&!e.classList.contains("ct-sortable-header"))return!1;var o=jQuery(t).attr("ng-attr-tree-id"),l=f.iframeScope.getComponentById(o),u=jQuery(e).attr("ng-attr-tree-id"),d=f.iframeScope.getComponentById(u);return!(!jQuery(l).is(".ct-inner-content")&&0<jQuery(l).find(".ct-section").length&&0<jQuery(d).closest(".ct-section").length)&&(!(0<jQuery(l).find(".ct-link").length&&0<jQuery(d).closest(".ct-link").length)&&(!(0<jQuery(l).find(".ct-link-text").length&&0<jQuery(d).closest(".ct-link").length)&&!(t.classList.contains("ct-sortable-modal")&&0<angular.element(e).closest(".ct-sortable-modal").length)))},revertOnSpill:!0,mirrorContainer:document.body}),f.iframeScope.$on("ct-dom-tree.drop",function(t,e,s,n){var r=e.index()-3,a=n[0].attributes["ng-attr-tree-id"].value,c=s[0].attributes["ng-attr-tree-id"].value;f.iframeScope.latestDroppedDOMParent=c,f.iframeScope.componentsReorder(e,r,a,c,n,s);var i=f.iframeScope.getComponentById(c).closest(".oxy-dynamic-list");0<i.length?f.iframeScope.rebuildDOM(parseInt(i.attr("ng-attr-component-id"))):e.hasClass("ct-sortable-navigator-column")&&(a==c?(f.iframeScope.rebuildDOM(a),f.iframeScope.rebuildDOM(c)):f.iframeScope.rebuildDOM(a)),jQuery(s).removeClass("ct-dom-tree-no-children"),jQuery(n).children().length<=3&&jQuery(n).addClass("ct-dom-tree-no-children"),f.iframeScope.adjustResizeBox()}),f.iframeScope.$on("ct-dom-tree.drag",function(t,e,s){var n=0;f.iframeScope.innerContentRoot&&f.iframeScope.innerContentRoot.id&&(n=f.iframeScope.innerContentRoot.id),a=c(angular.element("div#ct-dom-tree-node-"+n).html())}),f.iframeScope.$on("ct-dom-tree.cancel",function(t,e,s){e[0].attributes["ng-attr-tree-id"].value;var n=angular.element(e).parent().closest(".ct-dom-tree-node").attr("ng-attr-tree-id"),r=0;f.iframeScope.innerContentRoot&&f.iframeScope.innerContentRoot.id&&(r=f.iframeScope.innerContentRoot.id),a!==c(jQuery("div#ct-dom-tree-node-"+r).html())&&(0<n?f.iframeScope.updateDOMTreeNavigator(n):f.iframeScope.updateDOMTreeNavigator())}),f.iframeScope.$on("ct-dom-tree.dragend",function(t,e){n=null})})}]);
CTFrontendBuilderUI.controller("ControllerSlider",["$controller","$scope","$timeout","$interval",function(e,i,n,o){i.$parent.$on("iframe-init",function(e,t){jQuery("#ct-sidepanel").on("mousedown",".ct-sortable-slide",function(e){if(!(0<jQuery(e.target).parents(".ct-more-options-container").length)){var t=jQuery(this).closest(".ct-sortable-slider").attr("ng-attr-tree-id"),n=jQuery(this).index()-3;i.animateToSlide(t,n)}})}),i.$parent.addSlides=function(){var t=n(function(){var e=i.iframeScope.component.active.id;i.iframeScope.addComponent("ct_slide",!1,!0),i.iframeScope.addComponent("ct_slide",!1,!0),i.iframeScope.addComponent("ct_slide",!1,!0),i.iframeScope.updateDOMTreeNavigator(e),o.cancel(t)},0,!1)},i.$parent.animateToSlide=function(e,t){0<=t&&i.iframeScope.sliders[e].unslider("animate:"+t)},i.$parent.slideAdded=function(e,t){i.iframeScope.rebuildDOM(e);var n=i.iframeScope.getComponentById(t).closest("li").index();i.animateToSlide(e,n)}}]);