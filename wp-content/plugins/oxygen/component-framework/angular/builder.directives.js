...
CTFrontendBuilder.directive("ngBuilderWrap", function ($parentScope, $compile, $timeout, $interval) {
    ...
    return {
        ...
        link: function(scope, element) {
            ...
            scope.addComponent = function(componentName, type, notActivate, parent_id) {
                ...
                // Ul
                    ...
                    var innerWrap = insertData.activeComponent.children('div');
                ...
                if ( componentName == "ct_if_else_wrap" ) {                    
                    var timeout = $timeout(function() {
                        scope.addComponent("ct_if_wrap", false, true, component.id);
                        scope.addComponent("ct_else_wrap", false, true, component.id);
                ...
                if ( componentName == "oxy_dynamic_list" ) {                    
                    var timeout = $timeout(function() {
                        scope.addComponent("ct_div_block", false, true, component.id);
                        $interval.cancel(timeout);
                    }, 0, false);
                }
                ...
                if(componentName !== 'ct_span') {
                    var oxyList = scope.getComponentById(component.id).closest('.oxy-dynamic-list');
                    if(oxyList.length > 0) {
