					...
					<div class="oxy-condition-menu" ng-show="showConditionsMenu">
						...
						<div>
								...
								<div class='oxygen-control-wrapper' id='oxygen-control-layout-display'>
									...
									<div class='oxygen-control'>
										<div class='oxygen-button-list'>
											...
											<?php $this->button_list_button('conditionstype',null, 'AND', '', 'evalGlobalConditions()'); ?>
											<?php $this->button_list_button('conditionstype',1, 'OR', '', 'evalGlobalConditions()'); ?>
							...
							<div class="oxy-condition-menu-radios">
								...
								ng-change="iframeScope.setOption(iframeScope.component.active.id, iframeScope.component.active.name, 'conditionspreview'); evalGlobalConditions()" type="radio" value="2"> <?php _e("Always Show", "oxygen"); ?></label><br>
								<label><input ng-model="iframeScope.component.options[iframeScope.component.active.id]['model']['conditionspreview']"
								ng-change="iframeScope.setOption(iframeScope.component.active.id, iframeScope.component.active.name, 'conditionspreview'); evalGlobalConditions()"  type="radio" value="0"> <?php _e("Always Hide", "oxygen"); ?></label><br>
								<label><input ng-model="iframeScope.component.options[iframeScope.component.active.id]['model']['conditionspreview']"
								ng-change="iframeScope.setOption(iframeScope.component.active.id, iframeScope.component.active.name, 'conditionspreview'); evalGlobalConditions()"  type="radio" value="1"> <?php _e("Show/Hide Based on Conditions", "oxygen"); ?></label>
							</div>
						</div>
					</div>
				</div>
